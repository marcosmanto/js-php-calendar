...
/* harmony import */ var _note_editor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./note-editor */ "./src/modules/note-editor.js");
...
var Calendar = /*#__PURE__*/function () {
  function Calendar() {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__.default)(this, "enableKeyboardNavigation", true);
    ...
    var hoje = new Date();
    (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).current_day = {
      day: hoje.getDate(),
    ...
    (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date = hoje;
    this.renderCalendar();
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(Calendar, [{
    ...
    value: function events() {
      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _selButtonPrevMonth).addEventListener('click', this.previousMonth.bind(this));

      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _selButtonNextMonth).addEventListener('click', this.nextMonth.bind(this));
    ...
    value: function calendarCellEvents() {
      ...
      (0,_babel_runtime_helpers_classPrivateFieldSet__WEBPACK_IMPORTED_MODULE_3__.default)(this, _selCalendarCell, document.querySelectorAll('.calendar__number'));

      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _selCalendarCell).forEach(function (el) {
    ...
    key: "calendarDate",
    get: function get() {
      return (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date;
    },
    set: function set(newDate) {
      if (newDate) {
        (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date = newDate;
        this.renderCalendar();
    ...
    key: "lastCellClicked",
    get: function get() {
      return (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _selLastCellClicked);
    },
    set: function set(newElem) {
      if (newElem) {
        (0,_babel_runtime_helpers_classPrivateFieldSet__WEBPACK_IMPORTED_MODULE_3__.default)(this, _selLastCellClicked, newElem);
      }
    }
  }, {
    key: "onCellClick",
    ...
    value: function getDay() {
      var n = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).current_day.day;
    ...
    value: function getDayOffWeek() {
      var n = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).current_day.day_off_week;
      return (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).weekdays[n];
    }
  }, {
    key: "getMonth",
    value: function getMonth() {
      var n = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).current_day.month;
      return (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).months[n];
    }
  }, {
    key: "getYear",
    value: function getYear() {
      var n = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).current_day.year;
      return n;
    }
  }, {
    ...
    value: function renderCalendar() {
      ...
      var lastDayOfMonth = new Date((0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date.getFullYear(), (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date.getMonth() + 1, 0);
      var lastDayOfMonthWeekIndex = lastDayOfMonth.getDay();
      lastDayOfMonth = lastDayOfMonth.getDate();
      var previousMonthLastDay = new Date((0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date.getFullYear(), (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date.getMonth(), 0).getDate();
      var nextMonthDaysToShow = 7 - lastDayOfMonthWeekIndex - 1;
      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar = {
        month: (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date.getMonth(),
        year: (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date.getFullYear()
      };
    ...
    key: "attachNotes",
    value: function attachNotes() {
      this.calendarDaysNodeList.forEach(function (el) {
        if (_note_editor__WEBPACK_IMPORTED_MODULE_5__.default.NOTES.has(el.dataset.uid)) {
          el.classList.add('calendar__number--has-tooltip');
          el.insertAdjacentHTML('beforeend', "\n          <img src=\"images/note".concat(_note_editor__WEBPACK_IMPORTED_MODULE_5__.default.NOTES.get(el.dataset.uid).color, ".png\" alt=\"Note\">\n          <span>").concat(_note_editor__WEBPACK_IMPORTED_MODULE_5__.default.NOTES.get(el.dataset.uid).content, "</span>\n          ").trim());
        }
      });
    }
  }, {
    ...
    value: function renderNextMonthDays(numberOfDays) {
      ...
      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _selCalendarGrid).insertAdjacentHTML('beforeend', days);
    }
  }, {
    ...
    value: function renderCalendarMonthDays(numberOfDays) {
      ...
      for (var i = 1; i <= numberOfDays; i++) {
        var dataUID = new Date((0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date.getFullYear(), (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date.getMonth(), i).toLocaleDateString();

        if (i === new Date().getDate() && (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar_date.getMonth() === new Date().getMonth()) {
    ...
    value: function renderCurrentDay() {
      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _selCurDay_DayOfWeek).innerHTML = this.getDayOffWeek();
      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _selCurDay_Day).innerHTML = this.getDay();
      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _selCurDay_Month).innerHTML = this.getMonth();
      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _selCurDay_Year).innerHTML = this.getYear();
    }
  }, {
    key: "renderCalendarHeader",
    value: function renderCalendarHeader() {
      var year = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar.year;
      var month = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _data).calendar.month;
      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _selCal_Year).innerHTML = year;
      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _selCal_Month).innerHTML = this.getMonth(month);
    }
  }]);
...
var ColorChooser = /*#__PURE__*/function () {
  function ColorChooser(dialogObj) {
    ...
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__.default)(this, ColorChooser);
    ...
    this.getColorFromServer().then(function (color) {
      (0,_babel_runtime_helpers_classPrivateFieldSet__WEBPACK_IMPORTED_MODULE_4__.default)(_this, _currentThemeColor, color);

      (0,_babel_runtime_helpers_classPrivateFieldSet__WEBPACK_IMPORTED_MODULE_4__.default)(_this, _previousColorSelection, document.querySelector(".color-chooser [data-selected-color=\"".concat((0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(_this, _currentThemeColor), "\"]")).parentElement);

      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(_this, _selColorOptions).forEach(function (el) {
        el.parentElement.classList.remove('color-chooser__color-option--selected');

        if (el.dataset.selectedColor === (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(_this, _currentThemeColor)) {
    ...
    (0,_babel_runtime_helpers_classPrivateFieldSet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _dialogObject, dialogObj);

    this.events();
  }

  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(ColorChooser, [{
    key: "start",
    ...
    value: function events() {
      ...
      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(this, _selButtonUpdate).addEventListener('click', this.onUpdateClick.bind(this));

      (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(this, _selColorOptions).forEach(function (el) {
        return el.addEventListener('click', _this2.onColorSelected.bind(_this2));
      });
    }
  }, {
    ...
    value: function () {
      ...
      function getColorFromServer() {
        return _getColorFromServer.apply(this, arguments);
      }
    ...
    value: function onColorSelected(evt) {
      if ((0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(this, _previousColorSelection)) (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(this, _previousColorSelection).classList.remove('color-chooser__color-option--selected');

      (0,_babel_runtime_helpers_classPrivateFieldSet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _previousColorSelection, evt.target.parentElement);

      (0,_babel_runtime_helpers_classPrivateFieldSet__WEBPACK_IMPORTED_MODULE_4__.default)(this, _currentThemeColor, evt.target.dataset.selectedColor);
    ...
    key: "onUpdateClick",
    value: function () {
      var _onUpdateClick = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee2() {
        var _response2;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_6___default().post('index.php', qs__WEBPACK_IMPORTED_MODULE_7___default().stringify({
                  color: (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(this, _currentThemeColor)
                }), {
                  headers: {
                    'content-type': 'application/x-www-form-urlencoded;charset=utf-8'
                  }
    ...
    value: function updateColor() {
      var colorPicked = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(this, _currentThemeColor);
      document.querySelector(':root').style.setProperty('--primary-color', (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(this, _themeColors).get(colorPicked).color);
      document.querySelector(':root').style.setProperty('--off-color', (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(this, _themeColors).get(colorPicked).off_color);
    }
  }, {
    key: "dialog",
    get: function get() {
      return (0,_babel_runtime_helpers_classPrivateFieldGet__WEBPACK_IMPORTED_MODULE_3__.default)(this, _dialogObject);
    }
  }]);
...
var _classPrivateFieldGet = __webpack_require__(/*! @babel/runtime/helpers/classPrivateFieldGet */ "./node_modules/@babel/runtime/helpers/classPrivateFieldGet.js");

var _classPrivateFieldSet = __webpack_require__(/*! @babel/runtime/helpers/classPrivateFieldSet */ "./node_modules/@babel/runtime/helpers/classPrivateFieldSet.js");
...
var _selOverlay = /*#__PURE__*/new WeakMap();

var _selCloseButton = /*#__PURE__*/new WeakMap();
...
var _selDialogChildren = /*#__PURE__*/new WeakMap();
...
var Modal = /*#__PURE__*/function () {
  ...
  function Modal(modalType, calendarObj) {
    ...
    _selOverlay.set(this, {
      writable: true,
      value: document.querySelector('.dialog')
    });

    _selCloseButton.set(this, {
      writable: true,
      value: document.querySelector('.dialog i')
    });
    ...
    _selDialogChildren.set(this, {
      writable: true,
      value: document.querySelectorAll('.dialog *')
    });

    _classPrivateFieldSet(this, _currentModal, modalType);

    if (calendarObj) _classPrivateFieldSet(this, _calendar, calendarObj);
    this.events();
  }
  ...
  _createClass(Modal, [{
    ...
    value: function events() {
      ...
      _classPrivateFieldGet(this, _selDialogChildren).forEach(function (el) {
        return el.addEventListener('click', function (evt) {
          return evt.stopPropagation();
        });
      });

      _classPrivateFieldGet(this, _selCloseButton).addEventListener('click', function () {
        return _this.closeModal();
      });

      _classPrivateFieldGet(this, _selOverlay).addEventListener('click', function () {
        return _this.closeModal();
      });
    }
  }, {
    ...
    key: "attachAnimationPopupEvent",
    value: function attachAnimationPopupEvent() {
      _classPrivateFieldGet(this, _selPopUp).addEventListener('animationend', this.onPopupAnimationEnds.bind(this), {
        once: true,
        capture: true
      });
    }
  }, {
    key: "attachAnimationDialogEvent",
    value: function attachAnimationDialogEvent() {
      _classPrivateFieldGet(this, _selModal).addEventListener('animationend', this.onDialogAnimationEnds.bind(this), {
        once: true,
        capture: true
      });
    }
    ...
    value: function dettachAnimationEvents() {// this.#selModal.removeEventListener('animationend', this.onPopupAnimationEnds)
    ...
    key: "isEventInPopupContainer",
    value: function isEventInPopupContainer(evt) {
      if (evt.target === _classPrivateFieldGet(this, _selModal)) {
        return true;
      }
    ...
    get: function get() {
      ...
      if (_classPrivateFieldGet(this, _currentModal).closest('.dialog').classList.contains(this.modalType)) {
        return true;
      }
    ...
    key: "onDialogAnimationEnds",
    value: function onDialogAnimationEnds(evt) {
      ...
      if (!this.isEventInPopupContainer(evt)) return; //console.log('Dialog anim ends')
      ...
      if (_classPrivateFieldGet(this, _selModal).classList.contains(_classPrivateFieldGet(this, _cssClassFadeOut))) {
        ...
        _classPrivateFieldGet(this, _selModal).classList.remove(this.modalType);
    ...
    key: "onPopupAnimationEnds",
    value: function onPopupAnimationEnds(evt) {
      evt.stopPropagation(); //console.log('Popup anim ends')

      if (_classPrivateFieldGet(this, _selPopUp).classList.contains('dialog__popup--open')) {//console.log('opened popup')
      }
    ...
    value: function openModal() {
      ...
      _classPrivateFieldGet(this, _selModal).classList.add(_classPrivateFieldGet(this, _currentModal).classList[0]);
    ...
    value: function closeModal(evt) {
      if (!this.isEventInThisModal) return; //console.log('--------------')
...
var _selTextarea = /*#__PURE__*/new WeakMap();
